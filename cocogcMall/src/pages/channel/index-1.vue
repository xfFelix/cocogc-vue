<template>
  <div class="channel">
    <div class="nav-fixed" :class="homeSmWrap?tabBg:''" ref="headHeight">
      <mt-navbar class="page-navbar"  v-model="selected">
    ...
    <div class="page-navbar">
      <mt-tab-container class="page-tabbar-tab-container" v-model="selected" swipeable>
        <mt-tab-container-item id="tab-container1">
          ...
          <swiper-Ban :keyId="`1e0615c5b4b54caf97a366059249017d`"></swiper-Ban>
          <jingDong></jingDong>
        </mt-tab-container-item>

        <mt-tab-container-item id="tab-container2">
          <div class="head-ban yy"></div>
          <swiper-Ban :keyId="`683802f5671b4596b596d58402d92c4d`"></swiper-Ban>
          <yeYun></yeYun>
        </mt-tab-container-item>

        <mt-tab-container-item id="tab-container3">
          <div class="head-ban wy"></div>
          <swiper-Ban :keyId="`592a7c52f58344ba8c9acc42258d02d4`"></swiper-Ban>
          <wangYi></wangYi>
        </mt-tab-container-item>

        <mt-tab-container-item id="tab-container4">
          <div class="head-ban ty"></div>
          <swiper-Ban :keyId="`ee3d9939c33b482fa866fc0767fb10d6`"></swiper-Ban>
          <tianYa></tianYa>
        </mt-tab-container-item>
      </mt-tab-container>
    </div>
