...
export default {
  data:()=>({
    list:[
      {name:'居家生活',path:'',img:'/static/images/channel/wy-1-1.png'},
      {name:'数码家电',path:'',img:'/static/images/channel/wy-1-2.png'},
      {name:'服饰鞋包',path:'',img:'/static/images/channel/wy-1-3.png'},
      {name:'母婴亲子',path:'',img:'/static/images/channel/wy-1-4.png'}
    ]
  }),
  methods:{
    jumpPath(id){
